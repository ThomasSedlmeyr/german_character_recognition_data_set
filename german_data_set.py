...
class GermanLettersDataSet(tf.keras.utils.Sequence):
    ...
    def split_ds(self, test_size: float):
        ...
        image_data_train, image_data_test, labels_train, labels_test = train_test_split(self.image_data, self.labels,
                                                                                        test_size=test_size,
                                                            stratify=self.labels, random_state=42, shuffle=True)
    ...
    def show_image_point(self, image_index: int):
        img = self.image_data[image_index].reshape(40, 40, 1)
...
if __name__ == '__main__':
    #ds = GermanLettersDataSet('/home/thomas/Dokumente/Projekte/CHG_data_sets/CHG_Datenbank_komplett.csv')
    ...
    #ds.save_as_pickle("test_numbers.obj")
    #ds.export_to_csv("test_numbers.csv")
    ds2 = GermanLettersDataSet('test_numbers.csv')
    if ds != ds2:
    ...
    #ds = GermanLettersDataSet.load_from_pickle("all_letters_ds.obj")
    ...
    unicode_mapping = {'!': '\u0021', '$': '\u0024', 'A': '\u0041', 'B': '\u0042', 'C': '\u0043', 'D': '\u0044',
                       ...
                       'ß': '\u00DF'}
    ds.rename_ds(unicode_mapping)
    #print("Number different classes: " + str(len(ds.contained_classes)))
    #print(ds.contained_classes)
    ds.export_to_csv("characters_exported.csv")
